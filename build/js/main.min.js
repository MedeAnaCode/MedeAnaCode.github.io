...
var _modalInputFocus = require("./modules/modalInputFocus.js");
var _checkbox = require("./modules/checkbox.js");
var _newsButtons = require("./modules/news-buttons.js");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _newsButtons.initNewsButtons)();
    ...
    (0, _modalInputFocus.setFocus)();
    var form = new _form.Form();
    form.init();
    window.form = form;
    (0, _checkbox.initCheckboxes)();
  });
});
...
},{"./modules/checkbox.js":2,"./modules/feedbacks-swiper.js":3,"./modules/form-validate/form.js":5,"./modules/hero-swiper.js":11,"./modules/map.js":12,"./modules/menu.js":13,"./modules/modalInputFocus.js":14,"./modules/modals/init-modals.js":15,"./modules/news-buttons.js":17,"./modules/news-swiper.js":18,"./modules/programs-swiper.js":19,"./modules/select/custom-select.js":21,"./utils/ios-vh-fix.js":25,"./vendor/init-accordion.js":28}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initCheckboxes = void 0;
...
var checkboxes = document.querySelectorAll('[data-validate-type="checkbox"]');
...
var initCheckboxes = function initCheckboxes() {
...
var initFeedbacksSwiper = function initFeedbacksSwiper() {
  if (document.body.contains(document.querySelector('.feedbacks__slider'))) {
    ...
    new _swiper.default('.feedbacks__slider', {
      scrollbar: {
...
},{"../vendor/swiper.js":29}],4:[function(require,module,exports){
"use strict";
...
var initHeroSwiper = function initHeroSwiper() {
  if (document.body.contains(document.querySelector('.hero-block__slider'))) {
    // eslint-disable-next-line no-new
    new _swiper.default('.hero-block__slider', {
      loop: true,
      pagination: {
...
},{"../vendor/swiper.js":29}],12:[function(require,module,exports){
"use strict";
...
var initMap = function initMap() {
  ...
  // eslint-disable-next-line
  var marker = new L.Marker([55.02871595978264, 82.92825728618725], {
    icon: pin
  });
  marker.addTo(map);
};
...
},{"../utils/scroll-lock":26}],14:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.setFocus = void 0;
...
},{"../../utils/focus-lock":23,"../../utils/scroll-lock":26}],17:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initNewsButtons = void 0;
var buttonsList = document.querySelector('.news__buttons-list');
var buttons = document.querySelectorAll('.news__button');
var ACTIVE_CLASS = 'news__button--active';
var onButtonsListClick = function onButtonsListClick(evt) {
  var currentButton = evt.target.closest('.news__button');
  if (!currentButton.classList.contains(ACTIVE_CLASS)) {
    buttons.forEach(function (button) {
      return button.classList.remove(ACTIVE_CLASS);
    });
    currentButton.classList.add(ACTIVE_CLASS);
  }
};
var initNewsButtons = function initNewsButtons() {
  buttonsList.addEventListener('click', function (evt) {
    return onButtonsListClick(evt);
  });
};
exports.initNewsButtons = initNewsButtons;
...
var initNewsSwiper = function initNewsSwiper() {
  if (document.body.contains(document.querySelector('.news__slider'))) {
    // eslint-disable-next-line no-new
    new _swiper.default('.news__slider', {
      loop: false,
      breakpoints: {
        320: {
          slidesPerView: 1,
...
},{"../vendor/swiper.js":29}],19:[function(require,module,exports){
"use strict";
...
},{"../vendor/swiper.js":29}],20:[function(require,module,exports){
"use strict";
...
},{"./ios-checker":24}],27:[function(require,module,exports){
"use strict";
...
},{"./accordions.js":27}],29:[function(require,module,exports){
